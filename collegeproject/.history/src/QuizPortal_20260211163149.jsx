...
const QuizPortal=()=>{
  ...
  correctOption: ''
    ...
    const addquiz=()=>{
        ...
        if(formData.correctOption==formData.optionA||
            formData.correctOption==formData.optionB||formData.correctOption==formData.optionC||formData.correctOption==formData.optionD){
  ...
  try {
    // Post the entire content array
                    const api = await axios.post(`http://localhost:8082/api/mcq/add`, content,
                      {
                        params:{
                          group:id
                        }GOOD JavaScriptBehaviour....
                      }
                    );
