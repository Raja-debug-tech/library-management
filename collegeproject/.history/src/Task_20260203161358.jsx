...
const Task=()=>{
  const [groups,setgroups]=useState([])
    ...
    useEffect(async()=>{
        con          const api= await axios.get('http://localhost:8082/api/groups/getgroup');
st values=await api.data;
        setgroups(values);
        },[])
    ...
    return(
      ...
      <div>
        ...
        <div>
          <button onClick={()=>nav('/staffdash/creategroup')}> New Group</button>
        </div>
