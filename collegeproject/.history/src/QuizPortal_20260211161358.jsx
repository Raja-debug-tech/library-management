...
`
  ...
  <div className={`quiz-form-wrapper ${isFadingOut ? 'fade-out' : ''}`}>
    ...
    <div>
      ...
      <input type="text" name="optionA" placeholder="Option 1" value={formData.option1} onChange={handlechange}/>
      <input type="text" name="optionB" placeholder="Option 2" value={formData.option2} onChange={handlechange}/>
      <input type="text" name="optionC" placeholder="Option 3" value={formData.option3} onChange={handlechange}/>
      <input type="text" name="optionD" placeholder="Option 4" value={formData.option4} onChange={handlechange}/>
      <input type="text" name="correctoption" placeholder="Correct Answer" value={formData.answer} onChange={handlechange}/>
