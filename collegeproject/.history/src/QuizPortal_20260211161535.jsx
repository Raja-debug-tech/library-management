...
const QuizPortal=()=>{
  ...
  correctOption: ''
    ...
    const addquiz=()=>{
        ...
        if(formData.answer==formData.optionA||
            formData.                    question: '', optionA: '', optionB: '', optionC: '', optionD: '', correctoption: ''
==formData.optionB||formData.correctOption==formData.optionC||formData.correctOption==formData.optionD){
