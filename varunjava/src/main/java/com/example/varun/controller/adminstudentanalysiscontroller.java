...
import com.example.varun.service.StaffanalysisService;
...
public class adminstudentanalysiscontroller {
	...
	@Autowired
	StaffanalysisService stfservice;
...
//	}
	...
	@GetMapping("/staffanalysis/{name}/{phone}")
	public ResponseEntity<?> getStudentanalysis(@PathVariable String name, @PathVariable String phone) {

		return stfservice.getAnalitics(name, phone);
